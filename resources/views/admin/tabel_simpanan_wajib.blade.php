...
@section('judul','Tabel Simpanan Wajib')
...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Data Simpanan Wajib</h1>
    <p class="mb-4">Di halaman ini anda dapat melihat Simpanan Wajib</a>.</p>

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Tabel Simpanan Wajib</h6>
        </div>
        <div class="card-body">
            ...
            <div class="modal-body">
                <form id="form_carosel">
                    <div class="mb-3">
                        ...
                        <input type="hidden"  class="form-control" value="wajib"  id="jenis_simpanan" name="jenis_simpanan" aria-describedby="judul">
    ...
    var table = $('#dataTable2').DataTable({
        ajax: {
            url: `/admin/tabel-simpanan-wajib/data`,
            dataSrc: 'data',
        },
        columns: [
            {
