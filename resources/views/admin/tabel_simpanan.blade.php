...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Data Simpanan Pokok</h1>
    <p class="mb-4">Di halaman ini anda dapat melihat Simpanan Pokok</a>.</p>

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Tabel Simpanan Pokok</h6>
        </div>
        <div class="card-body">
            ...
            <div class="modal-body">
                <form id="form_carosel">
                    <div class="mb-3">
                        ...
                        <input type="hidden"  class="form-control" value="pokok"  id="jenis_simpanan" name="jenis_simpanan" aria-describedby="judul">
                        <input type="text" disabled class="form-control"  id="nama" name="nama" aria-describedby="judul">
                    </div>
                    <div class="mb-3">
                        <label for="rupiah" class="form-label">Jumlah Setor <a class="red-star">*</a></label>
                        <select class="form-control" required name="rupiah"  {{ auth()->user()->role == "bendahara"  ? '' :  'disabled' }} id="rupiah">
        ...
        columns: [
         ...
         aoColumnDefs: [{
                ...
                "render": function(data, catatan, row) {
                            ...
                            return `
                            <a class="" href="#"  id="btn_setor"
                            data-id="${data}"
                            data-id-anggota="${row.id_anggota}"
                            data-nama="${row.nama}"
